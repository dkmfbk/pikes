package eu.fbk.dkm.pikes.tintop.ita.morpho;
...
public class FstanRunnerBuffered {

    String command, model;
    OutputStream stdin;
    BufferedReader reader;

    public FstanRunnerBuffered(String command, String model) {
...
//            writer.close();
    ...
    public static void main(String[] args) {
        String command = "/Users/alessio/Desktop/File compresso/fstan";
        String model = "/Users/alessio/Documents/scripts/textpro/modules/MorphoPro/models/italian-utf8.fsa";

        FstanRunnerBuffered runner = new FstanRunnerBuffered(command, model);
        ArrayList<String> strings = new ArrayList<>();
